...
// UI Component: Accordion based on Radix UI.
...
const AccordionItem = React.forwardRef(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn("border-b last:border-b-0", className)} // Removed border-b for TaskItem styling
    {...props} />
));
AccordionItem.displayName = "AccordionItem"

const AccordionTrigger = React.forwardRef(({ className, children, hideChevron = false, ...props }, ref) => (
...
const AccordionContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    {...props}>
    {/* Removed default padding, apply padding where needed */} 
